    ...
    <section>
      ...
      <div className="mt-6 space-y-6">
        <div>
          ...
          <p className="mt-2 text-slate-700">Growing up as the eldest child taught me <strong>responsibility</strong>, <strong>resilience</strong>, and <strong>independence</strong> very early. I learned to be <strong>exploratory</strong>, take initiative, and maintain a sense of ownership in everything I do. Those early roles shaped the foundation of how I approach challenges today.</p>
        </div>

        <div>
          <h3 className="mt-6 text-lg font-semibold">Defining Moments</h3>
          <p className="mt-2 text-slate-700">A few key experiences had an outsized impact on my mindset:</p>
        ...
        <div>
          ...
          <p className="mt-2 text-slate-700">My love for engineering started with a love for <strong>logic</strong>. Math fascinated me, and the rush of <strong>solving problems</strong> naturally evolved into exploring computer science. Around the same time, the global buzz around the Y2K problem highlighted the real-world impact engineers could make. That convergence set me firmly on the path toward <strong>Computer Science Engineering</strong>.</p>
        </div>

        <div>
          <h3 className="mt-6 text-lg font-semibold">Growth Through Exploration</h3>
          <p className="mt-2 text-slate-700">I started my career as an intern who asked more questions than most people had patience for. But that <strong>curiosity</strong> became my accelerant.</p>
          <p className="mt-2 text-slate-700">Along the way, I learned:</p>
          <ul className="mt-2 list-disc list-inside pl-4 text-slate-700">
          ...
          <p className="mt-2 text-slate-700">These habits later became central to my engineering leadership style.</p>
        </div>

        <div>
          <h3 className="mt-6 text-lg font-semibold">From Building Features to Designing Systems</h3>
          <p className="mt-2 text-slate-700">Over the years, my work evolved from writing code to architecting <strong>large-scale</strong>, secure, <strong>high-performance</strong> platforms. I’ve worked across:</p>
          <ul className="mt-2 list-disc list-inside pl-4 text-slate-700">
          ...
          <p className="mt-2 text-slate-700">My focus expanded from fixing problems to <strong>creating systems</strong> that prevent them.</p>
        </div>

        <div>
          <h3 className="mt-6 text-lg font-semibold">Leadership Through Clarity and Empathy</h3>
          <p className="mt-2 text-slate-700">As I began leading teams, I realized that the strongest form of <strong>leadership</strong> is enabling others. I lead with:</p>
          <ul className="mt-2 list-disc list-inside pl-4 text-slate-700">
